...
class FinishedItemAdapter(private val listEvents: List<EventDetail>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    companion object {
    ...
    class EmptyViewHolder(private val binding: EmptyViewBinding) : RecyclerView.ViewHolder(binding.root)
